...
let beats = {
    ...
    "75": {
        ...
        button: new Button('#FDB232', 75),
    },
    "76": {
        beat: new Beat("./assets/Musical Orches 4.mp3"),
        button: new Button('#FDB232', 76),
    }
}
...
triggerBeat = (event) => {
    ...
    if(keyCode in beats){   //check if the key pressed in the beats class
...
//! This one is my own solution but there is a better solution other than that which is called transition end.
//  document.addEventListener('keyup', (event) => {
//     let keyCode = event.keyCode;
    
//     if(keyCode in beats){   
//         let keyPressed = beats[keyCode];
//         keyPressed.button.deselect();
//     }
//  })
